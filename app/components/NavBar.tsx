      ...
      <div className="flex ml-3">
        <a href="/">
          <div className="flex md:w-50">
            <img
              src={film.src}
              className="2xl:w-6 2xl:h-6 2xl:mr-2 2xl:mt-1 xl:h-6 xl:w-6 xl:mt-1 xl:mr-2 lg:h-6 lg:w-6 lg:mt-1 lg:mr-2 md:w-6 md:h-6 md:mt-1 md:mr-2 sm:w-6 sm:h-6 sm:mr-2 sm:mt-1 w-6 h-6 mr-2 mt-0.5"
              alt=""
            />
