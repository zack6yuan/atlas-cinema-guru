...
export default function SideBar() {
  return (
    <div className=" bg-teal-500 h-screen md:block sm:w-full sm:h-18 md:w-25 md:h-screen sm:-mt-189 md:hover:w-60 md:mt-30 fixed left-0 mt-30 group z-50">
      <div className="flex sm:justify-around md:block sm:ml-6 sm:mt-5 md:mt-6 md:ml-9 text-left">
        ...
        <div className="sm:w-1/3 md:w-10 md:mb-5 sm:hover:translate-x-5 transition duration-200">
          <a href="/favorites">
        ...
        <div className="sm:w-1/3 md:w-10 sm:hover:translate-x-5 transition duration-200 ">
          <a href="/watch-later">
            <img src={clock.src} alt="clock-icon" className="w-6 h-6" />
            <p className="-mt-6 ml-10 md:w-20 md:opacity-0 md:group-hover:opacity-100">Watch Later</p>
          </a>
        </div>
      </div>
