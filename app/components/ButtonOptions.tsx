...
export default function ButtonOptions() {
  return (
    <div className="absolute sm:top-5 sm:left-145 flex-row h-10 w-20">
      <button onClick={displayFavoritedAlert} className="hover:scale-130 transition duration-300">
        <img src={star.src} alt="star-icon" className="mr-2 cursor-pointer" />
      </button>
      <button onClick={displayWatchLaterAlert} className="hover:scale-130 transition duration-300">
